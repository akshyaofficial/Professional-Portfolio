...
const Hero = () => {
  ...
  link.href = '/Images/Akshya-Kumar-Panda-Resume.pdf';
  link.download = 'Akshya-Kumar-Panda-Resume.pdf';
  ...
  />
     ...
     <span className="text-primary-glow">Software Developer</span>
        ...
        <p ref={subtitleRef} className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
          Engineering-focused Full Stack & Cloud Engineer building scalable web platforms with MERN stack, AWS, and AI integration
        </p>
