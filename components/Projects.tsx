...
const Projects = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "Trident Watchtower – AI-Driven Maritime Threat Intelligence Console",
      description: "Architected a full-stack intelligence dashboard fusing live vessel tracks, geospatial analytics, and AI-driven threat scoring for real-time maritime monitoring with anomaly detection and risk insights.",
      image: "/Images/project-1.jpg",
      tech: ["React", "TypeScript", "Node.js", "Express", "MongoDB", "Python", "AI/ML"],
      liveUrl: "",
      githubUrl: ""
    },
    ...
    {
      id: 2,
      title: "PolyglotAI – AI-Integrated Language Learning Website",
      description: "Built an intelligent multilingual platform integrating AI, NLP, and speech recognition for adaptive, gamified learning with real-time feedback. Integrated Google OAuth and optimized REST APIs, improving authentication speed by 35%.",
      image: "/Images/project-2.jpg",
      tech: ["React", "Node.js", "Express", "MongoDB", "AI/NLP", "Google OAuth", "REST APIs"],
      liveUrl: "",
      githubUrl: ""
    },
    {
      id: 3,
      title: "Smart Solar Monitoring System",
      description: "Designed an IoT-based solar monitoring platform using sensors and ThingSpeak API for real-time data acquisition and analytics. Automated cloud synchronization with visual dashboards, improving energy tracking accuracy by 45%.",
      image: "/Images/project-3.jpg",
      tech: ["IoT", "Embedded C", "ThingSpeak", "Cloud", "Sensors", "Real-time Analytics"],
      liveUrl: "",
      githubUrl: ""
    }
